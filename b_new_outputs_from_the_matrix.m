function [average_searching_time, average_searching_distance, cum_revenue_parking_pricing] = ...
    b_new_outputs_from_the_matrix(Nns, Ns, Np, Nns_1, Nns_3, speed, cum_enterthearea, cum_enterthearea_3, decideforparking_3_fuel, decideforparking_3_electric, ...
    parking_pricing, parkingduration_expectation_fuel, parkingduration_expectation_electric)
...
total_number_parkers = cum_enterthearea_3(a-1);
...
total_revenue_parking = sum(decideforparking_3_fuel(:,1)*parking_pricing(1,1))*parkingduration_expectation_fuel/60 + ...
    sum(decideforparking_3_electric(:,1)*parking_pricing(1,1))*parkingduration_expectation_electric/60;
