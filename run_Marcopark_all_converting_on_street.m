% Run Marcopark ALL Converting On-Street:
% Multiple on-street garage convertion scenarios vs. avg searching time.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
close all
clc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    h1_setGlobal_number_of_parking_garages(3); % 3 parking garages
...
for j = 0:0.05:0.95
    ...
    h1_setGlobal_number_of_on_street_parking_spaces(207 - j*207)
    h1_setGlobal_capacity_garage(332/3 + (j*207/3)) %please change accordingly
...
save('results_scenario_converting_on_street_to_garage.mat')
...
xlabel('Percentage of on-street parking spaces converted to garage parking')
...
saveas(gcf,'Avg_searching_time_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_searching_time_converting_on_street_to_garage.fig')
...
saveas(gcf,'Avg_dgp_time_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_dgp_time_converting_on_street_to_garage.fig')

hold off

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1c.) Average searching and dgp time:
figure('units','normalized','outerposition',[0 0 1 1])
hold on
...
legend('Average searching time','Average time driving to garage parking')
set(gca,'FontSize',24)
...
saveas(gcf,'Avg_searching_dgp_time_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_searching_dgp_time_converting_on_street_to_garage.fig')

hold off

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 2a.) Total searching time:
figure('units','normalized','outerposition',[0 0 1 1])
hold on
x_value = 0:0.05:1;
...
saveas(gcf,'Total_searching_time_converting_on_street_to_garage.jpg')
saveas(gcf,'Total_searching_time_converting_on_street_to_garage.fig')
...
hold on
x_value = 0:0.05:1;
y_value = total_deciding_gp_time(:,1);

plot(x_value, y_value, 'b-', 'MarkerSize', 10, 'LineWidth', 4)
xlabel('Percentage of on-street parking spaces converted to garage parking')
ylabel('Total dgp time (in min/veh)')
set(gca,'FontSize',24)
...
saveas(gcf,'Total_dgp_time_converting_on_street_to_garage.jpg')
saveas(gcf,'Total_dgp_time_converting_on_street_to_garage.fig')

hold off

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 2c.) Total searching and dgp time:
figure('units','normalized','outerposition',[0 0 1 1])
hold on
...
xlabel('Percentage of on-street parking spaces converted to garage parking')
ylabel('Total time (in min/veh)')
legend('Total searching time','Total time driving to garage parking')
set(gca,'FontSize',24)
...
saveas(gcf,'Total_searching_dgp_time_converting_on_street_to_garage.jpg')
saveas(gcf,'Total_searching_dgp_time_converting_on_street_to_garage.fig')
...
saveas(gcf,'Avg_searching_distance_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_searching_distance_converting_on_street_to_garage.fig')
...
saveas(gcf,'Avg_dgp_distance_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_dgp_distance_converting_on_street_to_garage.fig')
...
xlabel('Percentage of on-street parking spaces converted to garage parking')
ylabel('Average distance (in km/veh)')
legend('Average searching distance','Average distance deciding for garage parking')
set(gca,'FontSize',24)
...
saveas(gcf,'Avg_searching_dgp_distance_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_searching_dgp_distance_converting_on_street_to_garage.fig')
...
saveas(gcf,'Total_searching_distance_converting_on_street_to_garage.jpg')
saveas(gcf,'Total_searching_distance_converting_on_street_to_garage.fig')
...
saveas(gcf,'Total_on_street_revenue_converting_on_street_to_garage.jpg')
saveas(gcf,'Total_on_street_revenue_converting_on_street_to_garage.fig')
...
saveas(gcf,'Total_garage_revenue_converting_on_street_to_garage.jpg')
saveas(gcf,'Total_garage_revenue_converting_on_street_to_garage.fig')
...
saveas(gcf,'Total_revenue_both_converting_on_street_to_garage.jpg')
saveas(gcf,'Total_revenue_both_converting_on_street_to_garage.fig')
