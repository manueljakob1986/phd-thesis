function [n_demand_total,n_demand]=c1_input_n_demand(i)
...
% n_demand_total = n_demand_total .* 0.96;
% n_demand(1,1) = n_demand(1,1) * 0.96;
% n_demand(2,1) = n_demand(2,1) * 0.96;
% n_demand(3,1) = n_demand(3,1) * 0.96;
% n_demand(4,1) = n_demand(4,1) * 0.96;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % demand increase by 4%:
% n_demand_total = n_demand_total .* 1.04;
% n_demand(1,1) = n_demand(1,1) * 1.04;
% n_demand(2,1) = n_demand(2,1) * 1.04;
% n_demand(3,1) = n_demand(3,1) * 1.04;
% n_demand(4,1) = n_demand(4,1) * 1.04;
