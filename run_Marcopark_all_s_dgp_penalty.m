% Run Marcopark ALL s/dgp penalty:
% Multiple s/dgp penalty scenarios vs. avg searching time.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
close all
clc
...
save('results_scenario_s_dgp_penalty.mat')
...
saveas(gcf,'Avg_searching_and_dgp_time_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_searching_and_dgp_time_converting_on_street_to_garage.fig')
...
saveas(gcf,'Avg_searching_and_dgp_distance_converting_on_street_to_garage.jpg')
saveas(gcf,'Avg_searching_and_dgp_distance_converting_on_street_to_garage.fig')
